...
function setIntentPosition(matchDetails) {
  ...
  if (defendingTeam != 'none') setDefenceRelativePos(matchDetails, defendingTeam, defendingTeam.closestPlayer)
  if (kickTeam != 'none') setAttackRelativePos(matchDetails, kickTeam)
  if (kickTeam == 'none' && defendingTeam == 'none') {
    setLooseintentPOS(matchDetails, kickOffTeam, kickOffTeam.closestPlayer)
    setLooseintentPOS(matchDetails, secondTeam, secondTeam.closestPlayer)
  }
}
