...
function closestPlayerToBall(closestPlayer, team, matchDetails) {
  ...
  for (let thisPlayer of team.players) {
    let proximityToBall = common.getDistance(thisPlayer.currentPOS[0], thisPlayer.currentPOS[1], position[0], position[1])
  ...
  team.closestPlayer = { playerID: closestPlayerDetails.playerID, name: closestPlayerDetails.name }
